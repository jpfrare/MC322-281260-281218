...
public class Ambiente {
    ...
    private final int Z_obstaculo;
    public final ArrayList<Robo> robos;

    public Ambiente(int x, int y, int z, int x_obstaculo, int y_obstaculo, int z_obstaculo) {
        ...
        this.Z_obstaculo = z_obstaculo;
        this.robos = new ArrayList<>();
    }

    public boolean eh_obstaculo(int x, int y, int z){
        //retorna true se as coordenadas x e y no parametro correspondem a localizacao x e y do obstaculo no ambiente
        return x == this.X_obstaculo && y == this.Y_obstaculo && z == this.Z_obstaculo;
    }
